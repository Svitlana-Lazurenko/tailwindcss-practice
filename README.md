# Markup of page "Food Delight" with Tailwind CSS
...
Here’s an example of a basic tailwind.config.js file with setting from this project:
...
After creating this file in project with Tailwind CSS (not CDN connection) you can use such styles as
